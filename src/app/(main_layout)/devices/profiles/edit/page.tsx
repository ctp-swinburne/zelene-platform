...
export default function DeviceProfileEditCatch() {
  ...
  return (
    <div className="container flex flex-col items-center justify-center gap-4 py-8">
      <Alert variant="destructive" className="max-w-md">
        ...
        <AlertDescription>
          You&apos;ve accessed an edit page without specifying a device profile
          ID. You will be redirected back automatically.
        </AlertDescription>
      </Alert>
